...
def load_gui(self):
    ...
    self.btn_submit = tk.Button(self.master,width=12,height=2,text='Submit',command=lambda: tracking_func.submit_List(self))
    ...
    self.btn_close = tk.Button(self.master,width=12,height=2,text='Close',command=lambda: tracking_func.ask_quit(self))
